...
int main(int argc, char *argv[])  // 主程式入口，接收命令列參數
{
    ...
    double base_load[50][24] ={  // 定義基載情境的二維陣列，包含50個情境，每個情境有24個時段的基載值
            ...
            {116,111,106,101,96,101,111,116,106,96,81,74,66,58,53,80,80,80,80,106,108,110,108,106},  // 第四十三個情境的基載資料
            {114,110,103,99,94,99,109,114,104,94,79,72,64,56,51,80,80,80,80,106,108,110,108,106},  // 第四十四個情境的基載資料
            {112,106,102,97,92,97,107,112,102,92,77,70,62,54,49,80,80,80,80,106,108,110,108,106},  // 第四十五個情境的基載資料
            {110,104,99,95,90,95,105,110,100,90,75,68,65,53,47,80,80,80,80,106,108,110,107,105} 
        };  // 基載陣列結束
