...
int main(int argc, char *argv[])  // 主程式入口，接收命令列參數
{
    ...
    double base_load[50][24] ={  // 定義基載情境的二維陣列，包含50個情境，每個情境有24個時段的基載值
            ...
            {114,110,103,99,94,99,109,114,104,94,79,72,64,56,51,80,80,80,80,106,108,110,108,106},  
            {112,106,102,97,92,97,107,112,102,92,77,70,62,54,49,80,80,80,80,106,108,110,108,106},  
